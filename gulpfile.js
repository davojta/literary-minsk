//TODO: it's not working need to fix
...
var path = {
	...
	react: 'src/**/*.jsx',
	html: 'src/*.html',
	templates: ['src/*.tpl.html', '!src/home.tpl.html'],
	...
	minify: 'dist/**/*.js',
	assets: ['./src/**/*.css', './src/**/*.svg', './src/**/*.woff', './src/**/*.ttf', './src/**/*.png', './src/**/*.ico', './src/**/*.gif', './src/**/*.jpg', './src/**/*.eot', './src/**/*.mp3'],
	json: './src/**/*.json',
	index: './src/home.tpl.html',
	watch: './src/**',
...
taskMaker.defineTask('copy', {taskName: 'pages', src: path.html, dest: path.output});
...
gulp.task('compile', function(callback) {
	return runSequence(['less', 'less-themes', 'pages', 'babel', 'json', 'assets'], callback);
});
